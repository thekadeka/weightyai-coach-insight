...
<div class="prose prose-lg max-w-none p-8">
  ...
  <p>This Privacy Notice for WeightyAI ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:</p>
  <ul>
      <li>Download and use our mobile application (WeightyAI), or any other application of ours that links to this Privacy Notice</li>
      <li>Engage with us in other related ways, including any sales, marketing, or events</li>
  </ul>
  <p><strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:kadeka@kadeka.net">kadeka@kadeka.net</a>.</p>

  <h2>SUMMARY OF KEY POINTS</h2>
  <p><em>This summary provides key points from our Privacy Notice, but you can find out more details about any of these topics by using our table of contents below to find the section you are looking for.</em></p>
  <p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about <a href="#what-info">personal information you disclose to us</a>.</p>
  <p><strong>Do we process any sensitive personal information?</strong> Some of the information may be considered "special" or "sensitive" in certain jurisdictions, for example your racial or ethnic origins, sexual orientation, and religious beliefs. We may process sensitive personal information when necessary with your consent or as otherwise permitted by applicable law. Learn more about <a href="#what-info">sensitive information we process</a>.</p>
  ...
  <p><strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Learn more about <a href="#your-rights">your privacy rights</a>.</p>
  ...
  <ol>
      ...
      <li><a href="#us-residents">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
  ...
  <p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by RevenueCat, Apple App Store, and Google Play Store. You may find their privacy notice link(s) here: <a href="https://www.revenuecat.com/privacy" target="_blank" rel="noopener noreferrer">https://www.revenuecat.com/privacy</a>, <a href="https://www.apple.com/legal/privacy/en-ww/" target="_blank" rel="noopener noreferrer">https://www.apple.com/legal/privacy/en-ww/</a>, and <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>.</p>
  ...
  <ul>
      ...
      <li><strong>To send you marketing and promotional communications.</strong> We may process the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. You can opt out of our marketing emails at any time. For more information, see <a href="#your-rights">"WHAT ARE YOUR PRIVACY RIGHTS?"</a> below.</li>
  ...
  <ul>
      <li><strong>User Account Registration and Authentication</strong>
          <ul>
              <li>Google OAuth 2.0 and Google Sign-In</li>
              <li>Apple Sign-In</li>
          </ul>
      </li>
      ...
      <li><strong>Data Backup & Security</strong>
          <ul>
              <li>Supabase</li>
          </ul>
      </li>
      <li><strong>Functionality & Infrastructure Optimization</strong>
          <ul>
              <li>Supabase</li>
          </ul>
      </li>
      <li><strong>Invoicing & Billing</strong>
          <ul>
              <li>RevenueCat</li>
          </ul>
      </li>
  ...
  <p>To the extent these online tracking technologies are deemed to be a "sale"/"sharing" (which includes targeted advertising, as defined under the applicable laws) under applicable US state laws, you can opt out of these online tracking technologies by submitting a request as described below under section <a href="#us-residents">"DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?"</a></p>
  ...
  <p>We provide the AI Products through third-party service providers ("AI Service Providers"), including OpenRouter. As outlined in this Privacy Notice, your input, output, and personal information will be shared with and processed by these AI Service Providers to enable your use of our AI Products for purposes outlined in "WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?" You must not use the AI Products in any way that violates the terms or policies of any AI Service Provider.</p>
  ...
  <h2 id="how-long">8. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
  ...
  <p>We do not knowingly collect, solicit data from, or market to children under 18 years of age or the equivalent age as specified by law in your jurisdiction, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or the equivalent age as specified by law in your jurisdiction or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 18 years of age or the equivalent age as specified by law in your jurisdiction has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18 or the equivalent age as specified by law in your jurisdiction, please contact us at <a href="mailto:kadeka@kadeka.net">kadeka@kadeka.net</a>.</p>

  <h2 id="your-rights">10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
  ...
  <p>In some regions (like the EEA, UK, Switzerland, and Canada), you have certain rights under applicable data protection laws. These may include the right (i) to request access and obtain a copy of your personal information, (ii) to request rectification or erasure; (iii) to restrict the processing of your personal information; (iv) if applicable, to data portability; and (v) not to be subject to automated decision-making. If a decision that produces legal or similarly significant effects is made solely by automated means, we will inform you, explain the main factors, and offer a simple way to request human review. In certain circumstances, you may also have the right to object to the aprocessing of your personal information. You can make such a request by contacting us by using the contact details provided in the section <a href="#contact-us">"HOW CAN YOU CONTACT US ABOUT THIS NOTICE?"</a> below.</p>
  ...
  <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:kadeka@kadeka.net">kadeka@kadeka.net</a>.</p>
  ...
  <h2 id="us-residents">12. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
  ...
  <p>The table below shows the categories of personal information we have collected in the past twelve (12) months. The table includes illustrative examples of each category and does not reflect the personal information we collect from you. For a comprehensive inventory of all personal information we process, please refer to the section <a href="#what-info">"WHAT INFORMATION DO WE COLLECT?"</a></p>
  <p><strong>Category: A. Identifiers</strong><br>
  Examples: Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name<br>
  Collected: YES</p>
  <p><strong>Category: B. Personal information as defined in the California Customer Records statute</strong><br>
  Examples: Name, contact information, education, employment, employment history, and financial information<br>
  Collected: YES</p>
  <p><strong>Category: C. Protected classification characteristics under state or federal law</strong><br>
  Examples: Gender, age, date of birth, race and ethnicity, national origin, marital status, and other demographic data<br>
  Collected: YES</p>
  <p><strong>Category: D. Commercial information</strong><br>
  Examples: Transaction information, purchase history, financial details, and payment information<br>
  Collected: YES</p>
  <p><strong>Category: E. Biometric information</strong><br>
  Examples: Fingerprints and voiceprints<br>
  Collected: NO</p>
  <p><strong>Category: F. Internet or other similar network activity</strong><br>
  Examples: Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements<br>
  Collected: NO</p>
  <p><strong>Category: G. Geolocation data</strong><br>
  Examples: Device location<br>
  Collected: NO</p>
  <p><strong>Category: H. Audio, electronic, sensory, or similar information</strong><br>
  Examples: Images and audio, video or call recordings created in connection with our business activities<br>
  Collected: NO</p>
  <p><strong>Category: I. Professional or employment-related information</strong><br>
  Examples: Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us<br>
  Collected: NO</p>
  <p><strong>Category: J. Education Information</strong><br>
  Examples: Student records and directory information<br>
  Collected: NO</p>
  <p><strong>Category: K. Inferences drawn from collected personal information</strong><br>
  Examples: Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual's preferences and characteristics<br>
  Collected: YES</p>
  <p><strong>Category: L. Sensitive personal Information</strong><br>
  Examples: Genetic data and health data<br>
  Collected: YES</p>
  ...
  <p>Learn more about the sources of personal information we collect in <a href="#what-info">"WHAT INFORMATION DO WE COLLECT?"</a></p>
  <h4>How We Use and Share Personal Information</h4>
  <p>Learn more about how we use your personal information in the section, <a href="#how-we-process">"HOW DO WE PROCESS YOUR INFORMATION?"</a></p>
  <h4>Will your information be shared with anyone else?</h4>
  <p>We may disclose your personal information with our service providers pursuant to a written contract between us and each service provider. Learn more about how we disclose personal information to in the section, <a href="#when-and-with-whom">"WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?"</a></p>
  ...
  <p>The categories of third parties to whom we disclosed personal information for a business or commercial purpose can be found under <a href="#when-and-with-whom">"WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?"</a></p>
  <h4>Your Rights</h4>
  ...
  <p>To exercise these rights, you can contact us by visiting __________, by emailing us at <a href="mailto:kadeka@kadeka.net">kadeka@kadeka.net</a>, or by referring to the contact details at the bottom of this document.</p>
  ...
  <h4>Appeals</h4>
  <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:kadeka@kadeka.net">kadeka@kadeka.net</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
  ...
  <h2 id="other-regions">13. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
  ...
  <p>If you believe we are unlawfully processing your personal information, you have the right to submit a complaint about a breach of the Australian Privacy Principles to the Office of the Australian Information Commissioner.</p>
  ...
  <h2 id="updates">14. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
  ...
  <h2 id="contact-us">15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
  <p>If you have questions or comments about this notice, you may email us at <a href="mailto:kadeka@kadeka.net">kadeka@kadeka.net</a> or contact us by post at:</p>
  <address>
  WeightyAI<br>
  jõe 30b<br>
  Keila, Harjumaa 76609<br>
  Estonia
  </address>

  <h2 id="review-update-delete">16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
